  ...
  drops: [
    {
      ...
      type: 'erc-721',
      startDate: utcToZonedTime(new Date('2023-07-20'), 'UTC').toISOString(),
      endDate: utcToZonedTime(new Date('2023-07-21'), 'UTC').toISOString(),
      price: '0.0001',
    },
    {
      ...
      name: 'Bass Face',
      startDate: utcToZonedTime(new Date('2023-07-20'), 'UTC').toISOString(),
      endDate: utcToZonedTime(new Date('2023-07-22'), 'UTC').toISOString(),
      crossMintClientId: '',
      address: '0x',
      type: 'external',
      price: '0.5',
