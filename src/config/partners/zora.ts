...
const zora: Partner = {
  ...
  drops: [
    ...
    {
      image:
        'https://assets.onchainsummer.xyz/FINAL_ART-Jah-Helmet%20City-Mecha_Gardens(TeaserTrailer).mp4',
      thumbnail: `/partners/zora/drops/Jah.png`,
    ...
    },
    {
      ...
      thumbnail: `/partners/zora/drops/Heno.png`,
