...
export const ChainChecker: React.FC = () => {
  ...
  return (
    <>
      {isMismatched && (
        <div className="flex flex-col md:flex-row relative top-16 md:top-auto justify-between items-center md:gap-4 px-6 md:px-8 py-4 bg-[#EFEFEF] rounded-[2rem] md:rounded-[2.5rem] w-full mx-6 md:mx-16">
          ...
          <div className="w-full md:w-auto md:basis-[1/3] flex justify-end">
            <Button
              ...
              className="mt-4 md:mt-0 basis-full md:basis-1/2 text-sm md:text-base !flex !justify-start md:!justify-between !bg-transparent"
            >
              Switch to Base
              <ChainSwitch />
            </Button>
